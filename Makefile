...
# Below is for running Dr. Fraser's Condition Variable code stuff:
all: build

build:
	gcc $(CFLAGS) demo_conditions.c general.c printer.c signaller.c -o demo_conditions.out -lpthread
